        ...
        <div class="box-body">
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control" id="title" value="{{ $page->name }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="content" class="col-lg-2 text-right">Contenu</label>
                    <div class="col-lg-10">
                        <textarea class="form-control" rows="10" name="text" id="content">{{ $page->text }}</textarea>
                    </div>
                </div>
